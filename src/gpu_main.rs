...
pub async fn gpu_main() {
    ...
    let material_img_20230226_201501 = gpu_context.create_material(
    ...
    let material_img_20230301_224920 = gpu_context.create_material(
    ...
    let material_img_20230301_225057 = gpu_context.create_material(
    ...
    let material_img_20231002_103537 = gpu_context.create_material(
    ...
    let material_img_20240714_1958 = gpu_context.create_material(
    ...
    let material_img_20241009161110 = gpu_context.create_material(

...
use crate::int::int_layer::{
    create_int_extracted_layer_box, create_int_filtered_layer, load_int_file_image_layer_box,
};
...
pub fn img_20241009_161110() {
    create_int_filtered_layer(
        create_int_extracted_layer_box(
            load_int_file_image_layer_box("./input/IMG20241009161110.jpg"),
            550,
            130,
            3600,
            3050,
    ...
    .save(get_path_out("20241009_161110.jpg"));
}
